					...
					<td>
						<form method="post" action="#" style="margin: 10px;" id="formcheckout">
							<div class="form-group">
								<label for="">1. Masukan dalam cart barang2 yang diinginkan dengan menambahkan barang di dengan menekan <b>Add To Cart</b></label>
								<label>2. Tekan Checkout untuk mengisi formulir pembayaran dan shipping address</label>
								<label>3. Setelah Terkonfirmasi pembayaran akan membuat link di halaman redirect, anda bisa melihat status pembayaran dan ID Order </label>
								<label>4. Tekan bayar dan anda akan diarahkan untuk membayar sesuai ketentuan</label>
								<label>Pengecekan order di halaman Check Order menggunakan ID Order Unique</label>
								<center><label><b>Selamat Berbelanja</b></label></center>
							</div>
