					...
					?>
						<form id="productform" action="#" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="namep" value='<?= $obj->nama_product ?>' name="name" required placeholder="Input product Name">
								<input type="hidden" class="form-control" value='<?= $obj->id_product ?>' name="id" required placeholder="Input product Name">
							</div>
							<div class="form-group">
								<label for="">Product Description</label>
								<textarea name="desc" placeholder="Product Description..." id="desc" class="form-control" rows="3" required="required"><?= $obj->deskripsi ?></textarea>
							</div>
							<div class="form-group">
								<label for="">Product Price</label>
								<input name="price" type="number" value='<?= $obj->harga_product ?>' onkeypress="return isNumber(event)" class="form-control" id="price" required placeholder="Input product price">
							</div>
							<div class="form-group">
								<label for="">Product Pcs</label>
								<input name="pcs" type="text" value='<?= $obj->satuan ?>' class="form-control" id="pcs" required placeholder="Input product price">
							</div>
							<div class="form-group">
								<label for="">Discount</label>
								<input name="discount" type="text" value='<?= $obj->diskon ?>' class="form-control" id="pcs" required placeholder="Input product price">
							</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#productform").submit(function(e) {
			...
			$.ajax({
				type: "post",
				url: "<?= base_url('company/product_edit_confirm') ?>",
				data: data,
				success: function(response) {
					swal(response);
				}
